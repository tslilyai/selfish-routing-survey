...
Further, this price of risk-aversion can be lower bounded for a specific case of a recursive Braess graph (Figure~\ref{fig:braess}) and the gap between the upper and
