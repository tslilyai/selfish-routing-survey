...
\begin{proof}
    ...
    Consequently, let's say we have a flow $x$ that is at the risk-averse Nash equilibrium for the individual cost function $c_e = \ell_e(x_e) +\gamma \upsilon_e(x_e)$. If $z$ is a risk-neutral Nash equilibirium, it is still feasible for the risk-averse
