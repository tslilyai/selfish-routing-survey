...
Further, this price of risk-aversion can be lower bounded for a specific case of a recursive Braess graph \XXX{have we mentioned this before}\XXX{LYT:Nope...should probably explain} and the gap between the upper and
