...
Note that the first term is exactly the individual user cost from the selfish routing model (and thus the two models are equivalent when $\beta = 0$). \XXX{xiaoyue: I'm confused because I thought the cost should have the amount of flow in it too}
