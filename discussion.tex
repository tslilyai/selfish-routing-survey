...
As we discussed earlier, more complex routing models, such as the diverse-interests model, allow us to create more fine-grained policies that take advantage of diversity of users' goals in a network to improve the network's overall efficiency (e.g., adding tolls to the network).
